...
local Mem = {}
function Mem.MemoryPatch(libName, offset, hexBytes)
...
local fontViews = {
  ...
  -- Replace the dgPatches section with this fixed version
local dgPatches = {
    { name = "Wallhack", patches = {
        { "libunity.so", 0x51ec608, "h80 00 00 36", "h1F 20 03 D5" } } },
    { name = "Kinetic Weapon", patches = {
        { "libunity.so", 0x4f98bac, "h01 00 A0 E3 1E FF 2F E1", "h20 00 80 D2 C0 03 5F D6" } } },
    { name = "No Recoil", patches = {
        { "libunity.so", 0xc733be4, "hE8 0F 1D FC F4 4F 01 A9", "h20 4C 40 BC C0 03 5F D6" } } },
    { name = "No Spread", patches = {
        { "libunity.so", 0xc73224c, "hE8 0F 1D FC F4 4F 01 A9", "h00 00 80 D2 C0 03 5F D6" } } },
    ...
    { name = "No Parachute", patches = {
        { "libunity.so", 0x614df2c, "hFF 43 02 D1 E9 23 02 6D", "h00 10 20 1E C0 03 5F D6" } } },
    { name = "Fast Scope", patches = {
        { "libunity.so", 0x4f138bc, "hE8 0F 1D FC F4 4F 01 A9", "h00 2C 40 BC C0 03 5F D6" } } },
    { name = "Fast Switch", patches = {
        { "libunity.so", 0x4ed67ac, "h00 2C 40 BC C0 03 5F D6", "h00 2C 40 BC C0 03 5F D6" } } },
    { name = "No Reload", patches = {
        { "libunity.so", 0xbd15568, "hEA 0F 1C FC E9 A3 00 6D", "h40 00 00 1C C0 03 5F D6" },
        { "libunity.so", 0x4ed5a5c, "hE8 0F 1D FC F4 4F 01 A9", "h40 00 00 1C C0 03 5F D6" } } },
    { name = "Pump Boost", patches = {
        { "libunity.so", 0x6ef5244, "hE8 0F 1D FC F4 4F 01 A9", "h20 00 80 D2 C0 03 5F D6" } } },
    { name = "Advance Uav", patches = {
        { "libunity.so", 0x67121c8, "hFF 03 02 D1 F8 5F 04 A9", "h20 00 80 D2 C0 03 5F D6" } } },
    ...
    { name = "Walk Underwater", patches = {
        { "libunity.so", 0x4fb7c5c, "hFF C3 01 D1 EA 1B 00 FD", "h20 00 80 D2 C0 03 5F D6" },
        { "libunity.so", 0x4fd558c, "hE0 03 1F 2A C0 03 5F D6", "h20 00 80 D2 C0 03 5F D6" },
        { "libunity.so", 0x521d60c, "hFD 7B BF A9 FD 03 00 91", "h20 00 80 D2 C0 03 5F D6" } } },
...
for i, cfg in ipairs(dgPatches) do
    local cb = _G["dg" .. i]
    cb.OnCheckedChangeListener = function(buttonView, isChecked)
        if isChecked then
